...
module.exports = (
   ...
   */
  const generateAuthenticationUrl = (backToPath, { policyName, journey, forceLogin = false, returnUrlObject = false, state = undefined } = {}) => {
   ...
   */
  const generateOutboundRedirectUrl = async (request, { backToPath, policyName, forceLogin, journey }, { state = null, stateCacheData = {}, redirectUri = undefined, clientId = undefined, serviceId = null } = {}) => {
