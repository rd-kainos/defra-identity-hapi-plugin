module.exports = {
  ...
  cacheSegment: 'idm',
  // Cache ttl in ms
  cacheTtlMs: 10 * 60 * 1000, // Ten minutes
  ...
  // @todo Determine whether this needs to be able to interrupt redirect or something
  preReturnUriRedirectFunc: async (request, tokenSet) => {}
}